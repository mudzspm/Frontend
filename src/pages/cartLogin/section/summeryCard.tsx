...
<div className="flex justify-between mt-5">
  <p className="text-lg text-[#000000DE] font-normal">
  Total
  </p>

  <p className="gap-2 flex items-center">
      <span className="text-base font-normal text-[#000000DE]">
        RM
      </span>
