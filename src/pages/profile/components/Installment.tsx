...
const Installment = ({ complete }: InstallmentProps) => {
    return (
        <div className="bg-[#F7F8FA] flex justify-between p-6 mt-4">
            <div className='flex gap-4'>
                <img src={transactionIcon} className='w-[100px] h-full' />
                <div className='flex flex-col gap-3'>
                    <p className='text-sm'>ID: XK3-6J</p>
                    <p className='text-xl font-medium'>Qurban  Cattle / portion</p>
                    <div className='flex gap-4 items-center'>
                        <div className='rounded-[26px] px-3 py-1 text-white bg-[#53AFBE] text-xs'>12 months</div>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <p className='text-xl font-medium'>RM 3000.00</p>
