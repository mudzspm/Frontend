      ...
      >
        ...
        <div className='absolute left-[387px] top-[206px]'>
          ...
          <div className='mt-[2.93rem] text-[#FFF] text-4xl'>
            <p>Distribute the meat to our brothers</p>
            <p>in need in 41 countries.</p>
          </div>
        </div>
      </div>
      ...
      <div className='grid gap-6 grid-cols-4 py-[8rem] px-[23.938rem] '>
        <div>
          ...
          <p className='text-[#3D565F] text-[0.819rem] mt-[0.768rem]'>
            Email{' '}
            <span className='text-[#EB414B]'> support@alithemes.com </span>{' '}
            <br />
            For help with a current product or <br /> service or refer to FAQs
            and developer <br /> tools{' '}
          </p>
        </div>
    ...
    w-full h-[2.932rem] rounded-[0.438rem] border-[#CDE2E7] '
        ...
        "target": "#hs-toggle-password"
                ...
                >
                  ...
                  >
                    <path
                      d='M13.3954 6.51185C13.3954 7.38057 13.0503 8.21371 12.436 8.82799C11.8217 9.44226 10.9886 9.78736 10.1199 9.78736C9.25113 9.78736 8.41799 9.44226 7.80371 8.82799C7.18943 8.21371 6.84433 7.38057 6.84433 6.51185C6.84433 5.64312 7.18943 4.80998 7.80371 4.1957C8.41799 3.58143 9.25113 3.23633 10.1199 3.23633C10.9886 3.23633 11.8217 3.58143 12.436 4.1957C13.0503 4.80998 13.3954 5.64312 13.3954 6.51185V6.51185ZM10.1199 12.244C8.59959 12.244 7.14159 12.8479 6.0666 13.9229C4.99162 14.9979 4.3877 16.4559 4.3877 17.9762H15.852C15.852 16.4559 15.2481 14.9979 14.1731 13.9229C13.0981 12.8479 11.6401 12.244 10.1199 12.244V12.244Z'
                      stroke='#8EA4AC'
                      stroke-width='1.63776'
        ...
        <div>
          <Accordion type='single' collapsible className='w-full'>
            <AccordionItem value='item-1'>
              <AccordionTrigger>
                What is Qurban and how does it work?
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value='item-2'>
              <AccordionTrigger>
                What are the conditions to perform Qurban?
              </AccordionTrigger>
              <AccordionContent>
