  ...
  return (
    <section className='grid grid-cols-2 gap-2 h-[100dvh] overflow-hidden '>
      ...
      <div className='m-auto '>
        ...
        <div
          id='otp'
          className='flex flex-row justify-center text-center  mt-9'
        >
          <input
            maxLength={1}
            className='font-bold text-2xl  rounded-l-[0.375rem] border-[#E4E4E7] h-[3.375rem] w-[3.125rem] text-center form-control  focus:ring-black focus-within:border-[#000] '
            type='text'
            id='first'
          />
          <input
          ...
          <input
            maxLength={1}
            className='font-bold text-2xl rounded-r-[0.375rem] border-[#E4E4E7] h-[3.375rem] w-[3.125rem] text-center form-control focus:ring-black focus-within:border-[#000]'
            type='text'
            id='sixth'
          />
        </div>
        ...
        <div className='mt-[1.3125rem] text-center'>
          <p className='text-xs text-[#1A1A1A]'>
            Didn’t receive code?{' '}
            <span className='text-[#000] font-bold text-xs'>
              {' '}
              Re-send code{' '}
            </span>
          </p>
        ...
        <div className='mt-7 text-center'>
          <Link
            to='/signup'
            className='text-xs text-[#1A1A1A] flex justify-center items-center gap-[0.563rem]'
          >
            <span>
